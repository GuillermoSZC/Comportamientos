...
#define UE_PROJECT_NAME Comportamientos_P5
#define UE_TARGET_NAME Comportamientos_P5Editor
#define UE_MODULE_NAME "Comportamientos_P5"
...
#define COMPORTAMIENTOS_P5_API DLLEXPORT
